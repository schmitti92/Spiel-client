...
<head>
  ...
  <title>Lichtarena – Tournament UI</title>
...
<body>
  <header class="topbar">
    <div class="brand">
      ...
      <div class="brandSub">Prototype – Offline</div>
    </div>
    ...
    <div class="topPills" role="status" aria-label="Status">
      ...
      <span class="pill"><span class="pillKey">Server-ready</span> später leicht umstellbar</span>
    </div>

    <button id="btnToggleUi" class="ghostBtn" type="button" aria-label="UI ein-/ausblenden">≡ UI</button>
  </header>
  ...
  <main class="shell">
    ...
    <section class="boardPanel">
      <div class="boardHeader">
        <div class="statusLine"><span class="muted">Status:</span> <span id="statusLine">–</span></div>
        <div class="hintLine" id="hintLine">Touch: 1 Finger ziehen = verschieben · 2 Finger = pinch-zoom · Maus: Scroll = zoom</div>
      </div>
      ...
      <div id="boardShell" class="boardViewport" aria-label="Spielbrett">
        ...
        <div class="camHud" aria-label="Zoom und Linien">
          ...
          <button id="btnZoomOut" class="hudBtn" type="button">−</button>
      ...
      <div class="uiStack">
        ...
        <section class="card">
          ...
          <div class="cardBody row">
            <button id="btnPrevTurn" class="btnIcon" type="button" aria-label="Vorheriger Spieler">◀</button>
            <div class="turnInfo">Figur anklicken → auswählen. Dann auf verbundenes Feld klicken = 1 Schritt.</div>
            <button id="btnNextTurn" class="btnIcon" type="button" aria-label="Nächster Spieler">▶</button>
          </div>
        </section>
        ...
        <section class="card">
          ...
          <div class="cardBody row">
            <button id="btnRoll" class="btnPrimary" type="button">Würfeln</button>
            <label class="field">
              <span class="fieldLabel">Wert (1–6)</span>
        ...
        <section class="card">
          <div class="cardHead">
            ...
            <div class="cardMeta">Aktiv: <span id="hudActiveLights">0</span> · Gesammelt: <span id="hudLightTotal">0</span>/<span id="hudLightGoal">5</span></div>
          </div>
          <div class="cardBody">
        ...
        <section class="card">
          ...
          <div class="cardBody row">
            ...
            <button id="btnClearDynamicBarricades" class="btnSecondary" type="button">Barikaden löschen</button>
          </div>
        </section>
  ...
  <script src="lichtarena_client.js?v=2"></script>
  <script>
    ...
    (function(){
      ...
      btn.addEventListener('click', ()=>{
        ...
        btn.textContent = ui.classList.contains('hidden') ? '≡ UI' : '⨯ UI';
      });
    })();
  </script>
  ...
  <div id="wheelOverlay" class="overlay hidden" aria-hidden="true">
    <div class="overlayCard" role="dialog" aria-modal="true" aria-label="Glücksrad">
      <div class="overlayTitle">🎡 Glücksrad – Joker Gewinn</div>
      <div class="wheelWrap">
      ...
      <div id="wheelResult" class="overlayResult">dreht…</div>
