...
function initGameState(room, activeColors) {
  ...
  const pieces = [];
  // IMPORTANT: Pieces exist for ALL 4 colors (red/blue/green/yellow),
  // even if not all colors participate in the current match.
  // Turn order is controlled by room.state.activeColors.
